...
#define SOFTWARE_VERSION_INTEGER    02	// 软件版本号
#define SOFTWARE_VERSION_DECIMAL    8	// 软件版本号
#define SOFTWARE_DATA_VERSION    	03	// 数据版本号


#define DBC_VERSION_H    	1	//dbc协议中显示的版本 高位
#define DBC_VERSION_L    	1//dbc协议中显示的版本 低位
