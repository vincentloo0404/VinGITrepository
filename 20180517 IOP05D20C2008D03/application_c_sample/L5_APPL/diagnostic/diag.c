...
uint16_t Driver13V_limtLow_Ct_u16 = 411; //9*(45.71248771)
uint16_t Driver13V_maxHigh_Ct_u16 = 777; //17*(45.71248771) //9V~17V

uint16_t LV_12V_limtLow_Ct_u16 = 274; //6*(45.71248771)
uint16_t LV_12V_maxHigh_Ct_u16 = 777; //17*(45.71248771) //6V~17V
...
volatile uint16 Curr_Input_IoutMax = (uint16)AC_INPUT_CURRENT_AD_CONVERT(DIAG_Curr_Input_IoutMax);// AC输入电流
//L3_I_AD_Curr_Input
...
const uint16 cp_pwm_senceTime = 1000 / DIAG_THREAD_CYCLE_TIME;//cp_pwm_senceTime CP 检查时间 ;
...
10 / DIAG_THREAD_CYCLE_TIME, //HWDCDC_OVPTime
		...
		3000/ DIAG_THREAD_CYCLE_TIME, //OverUinVoltTime
		5000/ DIAG_THREAD_CYCLE_TIME, //UnderUinVoltTime
...
5000 / DIAG_THREAD_CYCLE_TIME, //HWDCDC_OVPRecoverTime
		...
		3000 / DIAG_THREAD_CYCLE_TIME, //UinVoltRecoverTime
