...
/*---------------------------------------------------------------------------*/
	...
	#define		CLC_T2_FST_ADDR		CLR_CH4
...
/*---------------------------------------------------------------------------*/
		...
		#define		CLR_CH7_FST_CMD		ENABLE
		#define		CLR_CH7_FIFO_N		CTU_FIFO1 
		#define		CLR_CH7_ADC_B		AD_CH14     
		#define		CLR_CH7_ADC_A		AD_CH4		
...
/*---------------------------------------------------------------------------*/
		...
		#define		CLR_CH8_FIFO_N		CTU_FIFO0
