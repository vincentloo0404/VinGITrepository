...
#define CONDITION_BOOTLOADER  0
#define CONDITION_APP   1
...
uint8 programmingCondition  = 0xFFu;
/*****************************************************************************
*
...
uint16 s_dsmco_RC_handler (void)
{
    ...
    { 
        case 0x0203: 
        {
            ...
            programmingCondition = CONDITION_APP;
            break;
        }
        default:    
        {
...
uint16 s_dsmco_CommControl_handler (void)
{
    ...
    { 
        case 0x0301:
        {
            ...
            if (CommControlDiagMode == CommControlDiagModeOFF && DTCSettingDiagMode == DTCSettingDiagModeOFF && programmingCondition == CONDITION_APP)
        	{
        		lastDiagMode = 0x02;
	            send_positive_response(0x02);
...
{    
	...
	{
		fblUdsTxBuffer[i] = fblUdsRxBuffer[i];
...
void CAN_L3_TxUdsMsg(uint8* data)
{
	...
	L3_UdsTxMsgBuf_Str.ID.Bits.STD_ID = Tx_FBL_CAN_ID;
