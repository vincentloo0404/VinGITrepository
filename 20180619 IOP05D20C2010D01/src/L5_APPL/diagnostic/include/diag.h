...
#define VRelayCoil1_DIAG_Volt_OPEN_AD (512)
#define VRelayCoil1_DIAG_Volt_OPEN_AD_MAX (VRelayCoil1_DIAG_Volt_OPEN_AD+VRelayCoil1_DIAG_Volt_OPEN_AD_OFFSET)
#define VRelayCoil1_DIAG_Volt_OPEN_AD_MIN (VRelayCoil1_DIAG_Volt_OPEN_AD-VRelayCoil1_DIAG_Volt_OPEN_AD_OFFSET)
#define VRelayCoil1_DIAG_Volt_CLOSE (246)


#define AC_DIAG_Volt_MAX (265)
#define AC_DIAG_Volt_MIN (80)//85
#define AC_DIAG_OPEN_Volt_MIN (15)//


//#define DCDC_DIAG_IOUT_ZERO_AD_MIN (82)//0.4V
//#define DCDC_DIAG_IOUT_ZERO_AD_MAX (164)//0.8V*1024/5

#define DCDC_DIAG_IOUT_ZERO_AD_MIN (82)//0.4V
#define DCDC_DIAG_IOUT_ZERO_AD_MAX (164)//0.8*1024/5
...
#define CP_offset 0  //CP 占空比没有偏差 不需要加 offset
...
typedef union
{
    struct
    {
    	...
    	uint8_t bINPUT_Relay			:1;
    	uint8_t boutputCurrentSenError	:1;
    	uint8_t bPG_SENS				:1;
    	uint8_t bPFCBoostFail			:1;
    	uint8_t bOverACoutI				:1;
    	uint8_t bUinVoltOpen			:1;
    	
    	uint8_t bCANBUSOFF				:1;
    	uint8_t bCANMissing 			:1;
    	uint8_t bStartShortCircuit 		:1;
    	//uint8_t bFaultCP		 		:1;

        uint16_t bReserve:5       		;// Lowbyte
    }bit;
    uint32_t uDWORD;
}FaultCodeTag;
...
//#define ALL_FAULT_CODE_FLAG (0xFF80)
//1111 1111 1111 1111 1111 1111 11100000
#define ALL_FAULT_CODE_FLAG (0xFFFFFFE0)
//1111 1111 1111 1111 1111 1111 11110000
//#define ALL_FAULT_CODE_FLAG (0xFFFFFFF0)
...
extern uint8 ChrPlugIn_diag_handle(void);
